...
module "inception" {
  ...
  dmz_network            = "${google_compute_network.dmz.name}"
  dmz_subnetwork         = "${google_compute_subnetwork.dmz.name}"
  engineering_network    = "${google_compute_network.engineering.name}"
  engineering_subnetwork = "${google_compute_subnetwork.engineering.name}"
